        ...
        <div>
          ...
          <div className="p-6 border-b border-zinc-800">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-xl bg-[#926C3A] flex items-center justify-center text-white shadow-xs">
                <Scissors className="h-5 w-5" />
              </div>
              <div>
                <h2 className="font-serif font-bold text-base tracking-wide text-white">Milla Hair Studio</h2>
                <span className="text-[10px] text-[#926C3A] uppercase font-bold tracking-widest block mt-0.5">
                  Internal Workspace
                </span>
              </div>
            </div>
          ...
          <nav className="p-4 space-y-1 text-xs font-semibold">
            <button
              ...
              className={`w-full flex items-center justify-between p-3 rounded-xl transition-all ${
                activeNav === 'dashboard'
                  ? 'bg-[#926C3A] text-white shadow-xs font-bold'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <img
                ...
                className="h-9 w-9 rounded-full object-cover ring-2 ring-[#926C3A]/40"
              />
              <div className="text-left">
                <p className="text-xs font-bold text-white truncate max-w-[100px]">{currentUser.name}</p>
                <p className="text-[9px] text-zinc-400 capitalize">Internal Staff</p>
              </div>
            </div>
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-8">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              <h1 className="text-2xl sm:text-3xl font-serif font-bold text-zinc-900 flex items-center gap-2.5">
                <LayoutDashboard className="h-7 w-7 text-[#926C3A]" />
                Internal Booking Workspace
              </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm flex flex-col justify-between">
            <div className="flex justify-between items-start">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#926C3A] bg-amber-50 border border-[#926C3A]/30 px-3 py-1 rounded-full">
                  Akumulasi Bulan Ini ({currentYearMonth})
                </span>
                <h3 className="text-xs font-semibold text-zinc-500 mt-3">Pendapatan Bulan Ini</h3>
              </div>
              <div className="p-3 bg-[#926C3A] text-white rounded-xl shadow-xs">
            ...
            <div className="mt-4 pt-3 border-t border-zinc-100 flex justify-between items-baseline">
              ...
              <span className="text-[10px] text-[#926C3A] font-bold">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-zinc-100 pb-4">
            <div>
              ...
              <p className="text-xs text-zinc-500 mt-0.5">
                Terhubung langsung ke database Supabase live <code className="bg-zinc-100 text-[#926C3A] px-1 rounded">bookings</code>.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 bg-zinc-50 p-4 rounded-xl border border-zinc-200 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-xs p-2.5 bg-white border border-zinc-200 rounded-lg focus:outline-none focus:border-[#926C3A]"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full text-xs p-2.5 bg-white border border-zinc-200 rounded-lg focus:outline-none focus:border-[#926C3A] capitalize"
              >
              ...
              <div className="flex gap-1.5">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Nama / HP..."
                    className="w-full text-xs p-2.5 pl-8 bg-white border border-zinc-200 rounded-lg focus:outline-none focus:border-[#926C3A]"
                  />
                </div>
                  ...
                  filteredBookings.map((b) => (
                    <tr key={b.id} className="hover:bg-zinc-50 transition-colors">
                      <td className="p-3.5 font-bold text-zinc-900 flex items-center gap-2.5">
                        <div className="h-8 w-8 rounded-xl bg-zinc-100 text-[#926C3A] font-bold flex items-center justify-center text-xs border border-zinc-200">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/60 backdrop-blur-sm p-4 font-sans">
          <div className="w-full max-w-md bg-white rounded-2xl p-6 border border-zinc-200 shadow-xl space-y-5">
            ...
            <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-xl space-y-1.5 text-xs">
              ...
              <p className="text-zinc-700">Layanan: <span className="font-semibold text-[#926C3A]">{selectedBookingForComplete.service_name}</span></p>
            ...
            <form onSubmit={handleCreateBookingSubmit} className="space-y-3.5 text-left text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 p-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:outline-none focus:border-[#926C3A]"
                  required
                />
              </div>
