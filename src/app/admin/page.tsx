...
export default function AdminLoginPage() {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setErrorMsg('Kredensial tidak valid. Silakan periksa username dan kata sandi.');
    }
  };
    ...
    <div className="min-h-[85vh] bg-zinc-50 flex items-center justify-center p-4 font-sans text-zinc-900">
      ...
      >
        ...
        <div className="text-center space-y-2">
          <div className="h-12 w-12 rounded-2xl bg-zinc-900 text-[#C5A880] flex items-center justify-center mx-auto shadow-xs">
            <Scissors className="h-6 w-6" />
          </div>
          <h1 className="text-2xl font-serif font-bold text-zinc-900">Portal Admin Studio</h1>
        ...
        <form onSubmit={handleLoginSubmit} className="space-y-4 text-left text-xs">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full text-xs p-3.5 pl-10 bg-zinc-50 border border-zinc-200 rounded-xl text-zinc-900 focus:outline-none focus:border-[#C5A880] focus:ring-2 focus:ring-[#C5A880]/30 transition-all font-medium"
                required
              />
            </div>
          </div>
          ...
          <motion.button
            type="submit"
            whileTap={{ scale: 0.98 }}
            className="w-full bg-[#C5A880] hover:bg-[#b59870] text-white font-bold py-3.5 rounded-xl shadow-xs transition-all flex items-center justify-center gap-2 text-xs uppercase tracking-wider mt-2"
          >
            <span>Masuk Console Admin</span>
